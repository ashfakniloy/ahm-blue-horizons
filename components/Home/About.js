    ...
    <div id="about-us" className="py-10 lg:py-[100px]">
      <div className="flex flex-col items-center container">
        ...
        <p className="mt-8">
          ...
          obcaecati illum delectus assumenda facilis quis temporibus esse est.
          Tempora nemo quos maxime nisi voluptatibus. Dolore nisi a blanditiis
          voluptatem, id aut earum dolorem exercitationem, ab vero deleniti sit
          architecto perferendis sunt veniam omnis minima velit impedit ad iure!
          Quibusdam asperiores qui sequi beatae quidem fugit. Dicta quibusdam,
        ...
        <div className="mt-8 flex flex-col lg:flex-row lg:justify-between gap-5 lg:gap-10">
          <p className="">
            ...
            praesentium repellat ratione odit ad necessitatibus fugiat ab.
